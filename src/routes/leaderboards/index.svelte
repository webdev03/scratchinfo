...
<div class="leaderbar rounded">
  ...
  >
  <a href="/leaderboards/views" class="btn-primary"><i class="bi bi-eye-fill" /> Views</a>
  <a href="/leaderboards/loves" class="btn-primary"><i class="bi bi-heart-fill" /> Loves</a>
  <a href="/leaderboards/favourites" class="btn-primary"
    ><i class="bi bi-star-fill" /> Favourites</a
  >
