<script>
  ...
  let studioID = 0;
  let signedIn, problem, success = false;
...
<div class="alert alert-danger" role="alert">
  An error has occurred. This studio might exist already, or you need to sign in again. You also need to manage the studio.
</div>
{/if}
{#if success}
